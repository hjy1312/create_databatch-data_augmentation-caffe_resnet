...
env1=lmdb.open('/data/hjy1312/data/RESNET/cifar-10/cifar10_train_lmdb')
txn1=env1.begin()
cursor=txn1.cursor()
datum=caffe_pb2.Datum()

env2=lmdb.open('/data/hjy1312/data/RESNET/cifar-10/cifar10_pad4_train_lmdb',map_size=50000*1000*10)
