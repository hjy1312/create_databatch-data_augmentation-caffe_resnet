...
def load_CIFAR_batch_4param(filename):
  ...
  with open(filename, 'rb') as f:
    ...
    #X=X.reshape(10000,-1)
    Y = np.array(Y)
    return X, Y,batch_label,filenames
...
def get_CIFAR10_data(num_training=49000, num_validation=1000, num_test=1000):
    ...
    cifar10_dir = '/data/hjy1312/data/cs231n/assignment2/assignment2/cs231n/datasets/cifar-10-batches-py/'
