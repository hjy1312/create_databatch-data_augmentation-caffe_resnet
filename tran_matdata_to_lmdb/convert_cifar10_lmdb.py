...
print("Converting...")
cifar_caffe_directory=os.path.abspath("/data/hjy1312/data/RESNET/cifar-10/cifar10_train_lmdb")
if not os.path.exists(cifar_caffe_directory):
    ...
    env=lmdb.open('/data/hjy1312/data/RESNET/cifar-10/cifar10_test_lmdb',map_size=10000*1000*5)
    txn=env.begin(write=True)
    count=0
